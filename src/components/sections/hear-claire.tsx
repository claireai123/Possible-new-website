...
const outcomes = [
  ...
  { label: "Lead IQ", value: "Grade A — brief sent to intake" },
];
      ...
      <div className="relative mx-auto max-w-[1728px]">
        <div className="grid items-center gap-16 lg:grid-cols-[1fr_1.1fr]">
          ...
          <div>
            ...
            <h2
              className="mt-5 font-serif text-[clamp(2.5rem,5vw,56px)] text-[#0a0a0a]"
            ...
            <p className="mt-6 max-w-md text-[15px] leading-[1.5] text-[#0a0a0a]/45">
              ...
              consultation booked, lead graded and briefed to intake — under two minutes.
            </p>
          </div>
