...
const corePages: { url: string; source: string }[] = [
  ...
  { url: `${BASE_URL}/solutions/legal-answering-service`, source: "src/app/solutions/legal-answering-service/page.tsx" },
  { url: `${BASE_URL}/solutions/virtual-receptionist`, source: "src/app/solutions/virtual-receptionist/page.tsx" },
  { url: `${BASE_URL}/solutions/bilingual-answering-service`, source: "src/app/solutions/bilingual-answering-service/page.tsx" },
  { url: `${BASE_URL}/solutions/legal-intake`, source: "src/app/solutions/legal-intake/page.tsx" },
