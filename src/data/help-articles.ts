...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    lead: "ClaireAI bills a flat monthly subscription per firm. Plans include a monthly call allowance; overage is billed at $1.50–$2.50 per call depending on tier. No per-minute charges, no per-integration fees, no setup fees.",
    tldr: [
      "Flat monthly subscription. Plans: Starter $195, Practice $395, Firm $650 — all monthly.",
      "Each plan includes a call allowance: Starter 200, Practice 600, Firm unlimited.",
      "Overage on Starter and Practice: $1.50–$2.50 per qualified call. Spam/wrong number calls don't count.",
      "Invoiced on the 1st of each month via Stripe. Net-15 terms available for Firm-tier clients.",
      "Annual plans get a 15% discount and a price freeze for 24 months.",
    ],
    ...
    sections: [
      ...
      { type: "h2", text: "Annual vs monthly", id: "annual" },
      {
        ...
        items: [
          ...
          "Annual — 15% off the list price, paid up front, with a 24-month price freeze.",
          "Multi-office — discount stacks at 5 offices and above. Talk to sales.",
        ],
      },
    ],
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    lead: "If a caller says ClaireAI didn't answer, the cause is almost always the call forwarding configuration on your phone provider — not ClaireAI. Verify forwarding is active, check the carrier's last-mile logs, and re-run a test call. ClaireAI's answer rate at the platform layer is 99.97%.",
    tldr: [
